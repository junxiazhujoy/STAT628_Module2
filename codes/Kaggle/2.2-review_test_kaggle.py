...
data = [] 
for line in open('review_test.json', 'r'): 
...
#Add KaggleID in the data frame
KaggleIDs=[x['KaggleID'] for x in reviewsTEXT_clean]
Reviews_df['KaggleID']=KaggleIDs
print(Reviews_df.head(10))



from pandas import DataFrame
DataFrame.to_csv(Reviews_df,"review_test_kaggle.csv",index=False)
